...
export function PlayIcon(props) {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="#4ade80" {...props}>
...
export function CheckIcon(props) {
  return (
    <svg width="12" height="12" viewBox="0 0 20 20" fill="currentColor" {...props}>
...
export function EyeOffIcon(props) {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 11 7 11 7a13.16 13.16 0 0 1-3.05 3.94M6.61 6.61A13.5 13.5 0 0 0 1 12s4 7 11 7a10.44 10.44 0 0 0 5.39-1.61" />
